...
public:
  ...
  tempClass(){std::cout<<"Template Constructor";}; tempClass(t1){};
...
::SpaceFunc::Main::Main (const ::SpaceFunc::Main &cC)
{
  ...
  // template <typename T, int a, int b, typename T0 = int> T ::SpaceFunc::Main::tfunc0 (){ return &this->a; }
...
protected:
  // Inheritance () = default;
  int proA = 10;
  void baseProFunc(){ std::cout<<"I am base Pro Func"<<endl; }
...
private:
  // Inheritance () = delete;
  int priA = 10;
  void basePriFunc(){ std::cout<<"I am base Pvt Func"<<endl; }
...
public:
  ...
  int pubA = 10;
  void basePubFunc() { std::cout<<"I am base Pub Func"<<endl; }
  // --- BASE CLASS FUNCTIONS --- //
